...
# All feature set
model.form.all.features <- shared.specificity ~ avg.euc.dist + avg.kas + top.sg.median.kas + top.sg.euc.dist + avg.spearman + top.cosine.sim + kernel.count
...
write.csv(model1.train.pred.limited.features, paste0(out.path, "structure_features_model1_train_pred_limited_features.csv"), row.names = FALSE)
write.csv(model2.train.pred.limited.features, paste0(out.path, "structure_features_model2_train_pred_limited_features.csv"), row.names = FALSE)
...
write.csv(model1.test.pred.limited.features, paste0(out.path, "structure_features_model1_test_pred_limited_features.csv"), row.names = FALSE)
write.csv(model2.test.pred.limited.features, paste0(out.path, "structure_features_model2_test_pred_limited_features.csv"), row.names = FALSE)
